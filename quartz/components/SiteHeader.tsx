...
const navItems: NavItem[] = [
  {
    label: "首页",
    href: "/",
    matches: (slug) => slug === "index",
  },
  {
    label: "知识库",
    href: "/gpu/gpu-知识库索引",
    matches: (slug) => slug.startsWith("gpu/") && !slug.includes("gpu-kernel-learning"),
  },
  {
    label: "系统课程",
    href: "/gpu/gpu-kernel-learning/readme",
    matches: (slug) => slug.includes("gpu-kernel-learning"),
  },
  {
    label: "标签",
    href: "/tags/",
    matches: (slug) => slug.startsWith("tags/"),
  },
]
    ...
    <>
      ...
      <header class="site-header">
        <div class="site-header-inner">
          <a class="site-brand" href="/" aria-label="Zhenwei's Blog 首页">
            <span class="site-brand-mark" aria-hidden="true">
              Z
            </span>
            <span class="site-brand-text">Zhenwei's Blog</span>
          </a>

          <nav class="site-nav" aria-label="主导航">
            {navItems.map((item) => {
              const isActive = item.matches(slug)
              return (
                <a
          ...
          <div class="site-actions">
            ...
            <a
              ...
              href="https://github.com/ZhenweiCao"
              target="_blank"
              rel="noreferrer"
              aria-label="在 GitHub 查看 Zhenwei Cao"
            >
