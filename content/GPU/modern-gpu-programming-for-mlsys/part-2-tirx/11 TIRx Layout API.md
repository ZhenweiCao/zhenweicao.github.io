...
aliases:
  - "TIRx Layout API"
source: https://github.com/mlc-ai/modern-gpu-programming-for-mlsys/blob/8950d661e8499008546e3520c667c1cacec9af21/chapter_tirx_layout_api/index.md
...
> [!TIP] Overview
>
> - The TIRx layout API turns the layout notation from [[GPU/modern-gpu-programming-for-mlsys/part-1-gpu/03 Data Layout and Its Notation|Data Layout and Its Notation]] into compiler objects. The main objects are `TileLayout`, `SwizzleLayout`, and `ComposeLayout`.
...
[[GPU/modern-gpu-programming-for-mlsys/part-1-gpu/03 Data Layout and Its Notation|Data Layout and Its Notation]] introduced the notation used throughout this book: a tile shape, a set of strides over named axes, and an optional replication term for values that are copied rather than partitioned. This chapter turns that notation into the API used by the compiler.
...
Here the logical row maps to `TLane`, and the logical column maps to `TCol`. In [[GPU/modern-gpu-programming-for-mlsys/part-1-gpu/07 Tensor Memory - TMEM|Tensor Memory (TMEM)]], the hardware coordinates are called Lane and Col. In the TIRx layout notation, those hardware axes are written as `TLane` and `TCol`.
...
**Interactive: TIRx interactive layout demo.** [[GPU/modern-gpu-programming-for-mlsys/assets/interactive/tirx-layout-demo/index.html|Open as a full page]]

![[GPU/modern-gpu-programming-for-mlsys/assets/interactive/tirx-layout-demo/index.html|100%x1040]]
...
So the 32-row group is visible at TMEM lanes 0 through 31, 32 through 63, 64 through 95, and 96 through 127. This broadcasts the scale-factor group to four warps ([[GPU/modern-gpu-programming-for-mlsys/part-1-gpu/04 The Evolution of Tensor Core Data Layouts|The Evolution of Tensor Core Data Layouts]]). Each of the four warp-sized TMEM lane windows sees the same scale-factor group.
...
[[GPU/modern-gpu-programming-for-mlsys/part-2-tirx/10 Introduction to TIRx|Previous]] · [[GPU/modern-gpu-programming-for-mlsys/README|Book index]] · [[GPU/modern-gpu-programming-for-mlsys/part-3-gemm/12 Building a Tiled GEMM|Next]]
