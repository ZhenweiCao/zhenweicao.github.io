...
source: https://github.com/mlc-ai/modern-gpu-programming-for-mlsys/blob/8950d661e8499008546e3520c667c1cacec9af21/chapter_tma/index.md
...
**Interactive: TMA: the Tensor Memory Accelerator.** [[GPU/modern-gpu-programming-for-mlsys/assets/interactive/tma_intro.html|Open as a full page]]

![[GPU/modern-gpu-programming-for-mlsys/assets/interactive/tma_intro.html|100%x640]]
...
Swizzling changes the tile's physical arrangement, not its logical contents. The TMA descriptor, the shared-memory tile layout, and the later MMA instruction must all describe the same physical arrangement ([[GPU/modern-gpu-programming-for-mlsys/part-1-gpu/03 Data Layout and Its Notation|Data Layout and Its Notation]]). If TMA writes a 128-byte swizzle but MMA reads the data as a linear layout, the bytes have reached shared memory, but the Tensor Core will interpret them as the wrong matrix elements.
...
**Interactive: Using 3D TMA to move multiple swizzle atoms.** [[GPU/modern-gpu-programming-for-mlsys/assets/interactive/tma_3d.html|Open as a full page]]

![[GPU/modern-gpu-programming-for-mlsys/assets/interactive/tma_3d.html|100%x640]]
...
**Interactive: How 128-byte grouping affects bank conflicts.** [[GPU/modern-gpu-programming-for-mlsys/assets/interactive/tiling_constraint.html|Open as a full page]]

![[GPU/modern-gpu-programming-for-mlsys/assets/interactive/tiling_constraint.html|100%x640]]
*Toggle tiling, then select a column and a range of eight rows to compare bank-sector use with and without grouping.*

When the tile dimensions and target access pattern allow it, choose the widest swizzle the tile can hold so that accesses spread across more banks. An `N`-byte swizzle atom requires a contiguous dimension of at least `N` bytes. If the tile cannot hold a 128-byte atom, use a 64-byte or 32-byte swizzle instead ([[GPU/modern-gpu-programming-for-mlsys/part-1-gpu/03 Data Layout and Its Notation|Data Layout and Its Notation]]).
...
![[GPU/modern-gpu-programming-for-mlsys/assets/images/tma_sync_flow.svg]]

*TMA load synchronization: a thread issues copies and registers the byte count, the TMA engine updates the mbarrier after transferring the data, and the consumer waits for the phase to complete*
...
[[GPU/modern-gpu-programming-for-mlsys/part-1-gpu/04 The Evolution of Tensor Core Data Layouts|Previous]] · [[GPU/modern-gpu-programming-for-mlsys/README|Book index]] · [[GPU/modern-gpu-programming-for-mlsys/part-1-gpu/06 Blackwell Tensor Core - tcgen05 MMA|Next]]
